...
func (m *Model) updateSuggestions() {
	...
	if len(m.value) <= 0 {
		m.matchedSuggestions = StringsToRunes(
			m.AvailableSuggestions())
		return
	}
...
func StringsToRunes(input []string) [][]rune {
